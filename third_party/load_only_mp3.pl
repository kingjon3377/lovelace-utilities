...
sub putintodevice {
	...
	close(F);
	    ...
	    system("gst-launch-1.0 filesrc location=$f ! oggdemux !  vorbisdec ! audioconvert ! avenc_mp2 bitrate=$my_kbitrate ! id3v2mux ! filesink location=$mountpoint/$basename.mp3");
